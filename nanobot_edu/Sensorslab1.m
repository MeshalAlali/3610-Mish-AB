...
while(true)
    ...
    meanval = mean(vals);
    mean_voltage = meanval * (3.3 / 1023);  %copy the same equation from the last section
...
% Solution:
flat_voltage = 723 *(3.3 / 1023); % fill in the corresponding ADC value 
